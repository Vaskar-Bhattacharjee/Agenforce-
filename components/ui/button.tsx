  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === 'black' && 'bg-neutral-800 dark:bg-neutral-200 dark:text-black hover:bg-neutral-700 text-white hover:shadow-2xl  dark:hover:shadow-brand transition-shadow border border-neutral-400 dark:border-neutral-800',
