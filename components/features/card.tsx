...
export const CardSkeleton = ({className, children}: {
    ...
    return (
        <div className={cn('min-h-50 md:h-120 relative overflow-hidden flex flex-col items-start justify-center perspective-distant   md:max-w-100 mx-auto',className)}>
            {children}
        </div>
    )
}
