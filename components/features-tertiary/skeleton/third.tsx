            ...
            >
              ...
              <p
                className={cn(
                  "text-xs font-medium",
                  {
                    "text-neutral-800 dark:text-neutral-200  transition duration-300":
        ...
        <motion.div className="bg-gray-200 dark:bg-neutral-700 rounded-lg mx-auto min-h-70  md:min-w-[85%]">
          <Card index={0} className="p-4">
            <motion.div
              ...
              className={cn(
                "flex items-center justify-center rounded-md border border-gray-300 w-8 h-8 px-1 ml-4 mt-6"
              )}
            >
              {selected.icon2}
            </motion.div>
